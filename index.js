...
*/
  ...
  var $author$project$Routes$Support = { $: "Support" };
  var $author$project$Main$getRouteFromPath = function (path) {
    switch (path) {
      case "/about":
        return $author$project$Routes$About;
      case "/ついて":
        return $author$project$Routes$About;
      case "/support":
        return $author$project$Routes$Support;
      case "/ありがとう":
        return $author$project$Routes$Support;
      default:
        return $author$project$Routes$Home;
    }
  };
  var $elm$core$Platform$Cmd$batch = _Platform_batch;
  var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
  var $author$project$Subject$Animals = { $: "Animals" };
  var $author$project$Subject$BodyParts = { $: "BodyParts" };
  var $author$project$Part$Bottom = { $: "Bottom" };
  ...
  var $author$project$Part$Hang = { $: "Hang" };
  var $author$project$Part$Left = { $: "Left" };
  var $author$project$Subject$ManMadeTools = { $: "ManMadeTools" };
  var $author$project$Subject$MathAndMeasurement = { $: "MathAndMeasurement" };
  var $author$project$Subject$NaturalMaterials = { $: "NaturalMaterials" };
  var $author$project$Subject$Nature = { $: "Nature" };
  var $author$project$Part$None = { $: "None" };
  var $author$project$Subject$People = { $: "People" };
  var $author$project$soundComponent$soundComponent = F7(function (
    soundComponent,
    name,
    meaning,
    alternates,
  ...
  var $author$project$Part$Right = { $: "Right" };
  var $author$project$Meaning$Same = { $: "Same" };
  var $author$project$Subject$Senses = { $: "Senses" };
  var $author$project$Subject$Supernatural = { $: "Supernatural" };
  var $author$project$Part$Top = { $: "Top" };
  var $author$project$Subject$VerbsAndLanguage = { $: "VerbsAndLanguage" };
  var $author$project$Subject$Warfare = { $: "Warfare" };
  var $author$project$Part$Wrap = { $: "Wrap" };
  var $author$project$Radicals$radicals = _List_fromArray([
    A7(
      $author$project$soundComponent$soundComponent,
      _Utils_chr("水"),
      "みず",
      $author$project$Meaning$Same,
      _List_fromArray([_Utils_chr("氵")]),
      $author$project$Part$None,
      _List_Nil,
      $author$project$Subject$Nature
    ),
    A7(
      $author$project$soundComponent$soundComponent,
      _Utils_chr("氵"),
    ...
    A7(
      ...
      $author$project$Part$None,
      _List_Nil,
      $author$project$Subject$BodyParts
    ),
    A7(
      $author$project$soundComponent$soundComponent,
      _Utils_chr("手"),
    ...
    A7(
      ...
      "こころ",
      $author$project$Meaning$Same,
      _List_fromArray([_Utils_chr("⺗"), _Utils_chr("⺖")]),
      $author$project$Part$None,
      _List_Nil,
      $author$project$Subject$BodyParts
    ),
    A7(
      ...
      _List_fromArray([_Utils_chr("心"), _Utils_chr("⺖")]),
      $author$project$Part$Bottom,
      _List_Nil,
      $author$project$Subject$BodyParts
    ),
    ...
    A7(
      ...
      "ひと",
      $author$project$Meaning$Same,
      _List_fromArray([_Utils_chr("亻"), _Utils_chr("𠆢")]),
      $author$project$Part$None,
      _List_Nil,
      $author$project$Subject$People
    ),
    A7(
      $author$project$soundComponent$soundComponent,
      _Utils_chr("亻"),
      ...
      _List_fromArray([_Utils_chr("人"), _Utils_chr("𠆢")]),
      $author$project$Part$Left,
      _List_Nil,
      $author$project$Subject$People
    ),
    A7(
      ...
      "ひとやね",
      $author$project$Meaning$Different("人"),
      _List_fromArray([_Utils_chr("人"), _Utils_chr("亻")]),
      $author$project$Part$Top,
      _List_Nil,
      $author$project$Subject$People
    ),
    ...
    A7(
      ...
      _List_Nil,
      $author$project$Subject$Enclosures
    ),
    A7(
      $author$project$soundComponent$soundComponent,
      _Utils_chr("疒"),
    ...
    A7(
      ...
      $author$project$Part$None,
      _List_Nil,
      $author$project$Subject$VerbsAndLanguage
    ),
    A7(
      $author$project$soundComponent$soundComponent,
      _Utils_chr("食"),
    ...
    A7(
      ...
      $author$project$Part$None,
      _List_Nil,
      $author$project$Subject$NaturalMaterials
    ),
    A7(
      $author$project$soundComponent$soundComponent,
      _Utils_chr("糸"),
    ...
    A7(
      ...
      $author$project$Part$None,
      _List_Nil,
      $author$project$Subject$MathAndMeasurement
    ),
    A7(
      $author$project$soundComponent$soundComponent,
      _Utils_chr("二"),
    ...
    A7(
      ...
      _List_fromArray([_Utils_chr("西"), _Utils_chr("⻃")]),
      $author$project$Part$None,
      _List_Nil,
      $author$project$Subject$MathAndMeasurement
    ),
    ...
    A7(
      ...
      $author$project$Part$None,
      _List_Nil,
      $author$project$Subject$Animals
    ),
    A7(
      $author$project$soundComponent$soundComponent,
      _Utils_chr("犬"),
    ...
    A7(
      ...
      "かたな",
      $author$project$Meaning$Same,
      _List_fromArray([_Utils_chr("刂")]),
      $author$project$Part$None,
      _List_Nil,
      $author$project$Subject$Warfare
    ),
    A7(
      $author$project$soundComponent$soundComponent,
      _Utils_chr("刂"),
    ...
    A7(
      ...
      $author$project$Part$None,
      _List_Nil,
      $author$project$Subject$ManMadeTools
    ),
    A7(
      $author$project$soundComponent$soundComponent,
      _Utils_chr("罒"),
      ...
      _List_fromArray([_Utils_chr("网"), _Utils_chr("⺳")]),
      $author$project$Part$Top,
      _List_Nil,
      $author$project$Subject$ManMadeTools
    ),
    A7(
      ...
      "あみがしら",
      $author$project$Meaning$Different("網目"),
      _List_fromArray([_Utils_chr("罒"), _Utils_chr("网")]),
      $author$project$Part$None,
      _List_Nil,
      $author$project$Subject$ManMadeTools
    ),
    A7(
      ...
      "あみめ",
      $author$project$Meaning$Same,
      _List_fromArray([_Utils_chr("罒"), _Utils_chr("⺳")]),
      $author$project$Part$None,
      _List_Nil,
      $author$project$Subject$ManMadeTools
    ),
    ...
    A7(
      ...
      $author$project$Part$None,
      _List_Nil,
      $author$project$Subject$Supernatural
    ),
    A7(
      $author$project$soundComponent$soundComponent,
      _Utils_chr("竜"),
  ...
  var $author$project$Main$keyDownListener = A2(
    $elm$json$Json$Decode$map,
    $author$project$Main$KeyDown,
    $author$project$Main$decodeKey
  );
    ...
    return $elm$core$Platform$Sub$batch(
      _List_fromArray([
        $elm$browser$Browser$Events$onKeyDown(
          $author$project$Main$keyDownListener
        ),
      ])
    );
  };
  var $author$project$Main$deselectRadical = function (model) {
    return _Utils_Tuple2(
      _Utils_update(model, { selected: $elm$core$Maybe$Nothing }),
      $elm$core$Platform$Cmd$none
    );
  };
  var $author$project$Main$handleKeyDown = F2(function (key, model) {
    if (key === "Escape") {
    ...
    switch (msg.$) {
      case "LinkClicked":
        ...
        if (urlRequest.$ === "Internal") {
          ...
          return _Utils_Tuple2(
            model,
            $elm$browser$Browser$Navigation$load($elm$url$Url$toString(url))
          );
        } else {
      ...
      case "SelectRadical":
        var soundComponent = msg.a;
        return _Utils_Tuple2(
          _Utils_update(model, {
            selected: $elm$core$Maybe$Just(soundComponent),
          }),
          $elm$core$Platform$Cmd$none
        );
      ...
      default:
        ...
        return _Utils_Tuple2(
          _Utils_update(model, {
            display: option,
            route: $author$project$Routes$Home,
          }),
          $elm$core$Platform$Cmd$none
        );
    }
  });
  var $mdgriffith$elm_ui$Element$FocusStyle = F3(function (
    borderColor,
    backgroundColor,
    shadow
  ) {
  ...
  var $author$project$Pages$about = {
    content: $author$project$Pages$aboutCopy,
    route: $author$project$Routes$About,
    title: "このアプリでついて",
  };
  ...
  var $mdgriffith$elm_ui$Internal$Flag$flag = function (i) {
    return i > 31
      ? $mdgriffith$elm_ui$Internal$Flag$Second(1 << (i - 32))
      : $mdgriffith$elm_ui$Internal$Flag$Flag(1 << i);
  };
  var $mdgriffith$elm_ui$Internal$Flag$bgColor =
    $mdgriffith$elm_ui$Internal$Flag$flag(8);
  ...
  var $mdgriffith$elm_ui$Internal$Model$formatColorClass = function (_v0) {
    ...
    var alpha = _v0.d;
    return (
      $mdgriffith$elm_ui$Internal$Model$floatClass(red) +
      ("-" +
        ($mdgriffith$elm_ui$Internal$Model$floatClass(green) +
          ("-" +
            ($mdgriffith$elm_ui$Internal$Model$floatClass(blue) +
              ("-" + $mdgriffith$elm_ui$Internal$Model$floatClass(alpha))))))
    );
  };
  ...
  var $mdgriffith$elm_ui$Internal$Flag$fontColor =
    $mdgriffith$elm_ui$Internal$Flag$flag(14);
  ...
  var $mdgriffith$elm_ui$Internal$Model$div =
    $mdgriffith$elm_ui$Internal$Model$Generic;
  var $mdgriffith$elm_ui$Internal$Model$NoNearbyChildren = {
    $: "NoNearbyChildren",
  };
  var $mdgriffith$elm_ui$Internal$Model$columnClass =
    $mdgriffith$elm_ui$Internal$Style$classes.any +
    (" " + $mdgriffith$elm_ui$Internal$Style$classes.column);
  var $mdgriffith$elm_ui$Internal$Model$gridClass =
    $mdgriffith$elm_ui$Internal$Style$classes.any +
    (" " + $mdgriffith$elm_ui$Internal$Style$classes.grid);
  var $mdgriffith$elm_ui$Internal$Model$pageClass =
    $mdgriffith$elm_ui$Internal$Style$classes.any +
    (" " + $mdgriffith$elm_ui$Internal$Style$classes.page);
  var $mdgriffith$elm_ui$Internal$Model$paragraphClass =
    $mdgriffith$elm_ui$Internal$Style$classes.any +
    (" " + $mdgriffith$elm_ui$Internal$Style$classes.paragraph);
  var $mdgriffith$elm_ui$Internal$Model$rowClass =
    $mdgriffith$elm_ui$Internal$Style$classes.any +
    (" " + $mdgriffith$elm_ui$Internal$Style$classes.row);
  var $mdgriffith$elm_ui$Internal$Model$singleClass =
    $mdgriffith$elm_ui$Internal$Style$classes.any +
  ...
  var $mdgriffith$elm_ui$Internal$Model$addChildren = F2(function (
    existing,
    nearbyChildren
  ) {
  ...
  var $mdgriffith$elm_ui$Internal$Model$addKeyedChildren = F3(function (
    key,
    existing,
    nearbyChildren
  ) {
  ...
  var $mdgriffith$elm_ui$Internal$Flag$alignBottom =
    $mdgriffith$elm_ui$Internal$Flag$flag(41);
  var $mdgriffith$elm_ui$Internal$Flag$alignRight =
    $mdgriffith$elm_ui$Internal$Flag$flag(40);
  var $mdgriffith$elm_ui$Internal$Flag$centerX =
    $mdgriffith$elm_ui$Internal$Flag$flag(42);
  var $mdgriffith$elm_ui$Internal$Flag$centerY =
    $mdgriffith$elm_ui$Internal$Flag$flag(43);
      ...
      case "Min":
        ...
        return (
          ...
          ($elm$core$String$fromInt(min) +
            $mdgriffith$elm_ui$Internal$Model$lengthClassName(len))
        );
      default:
        var max = x.a;
        var len = x.b;
  ...
  var $mdgriffith$elm_ui$Internal$Model$transformClass = function (transform) {
    switch (transform.$) {
      ...
      case "Moved":
        ...
        return $elm$core$Maybe$Just(
          "mv-" +
            ($mdgriffith$elm_ui$Internal$Model$floatClass(x) +
              ("-" +
                ($mdgriffith$elm_ui$Internal$Model$floatClass(y) +
                  ("-" + $mdgriffith$elm_ui$Internal$Model$floatClass(z)))))
        );
      default:
        var _v2 = transform.a;
        var tx = _v2.a;
        ...
        return $elm$core$Maybe$Just(
          "tfrm-" +
            ($mdgriffith$elm_ui$Internal$Model$floatClass(tx) +
              ("-" +
                ($mdgriffith$elm_ui$Internal$Model$floatClass(ty) +
                  ("-" +
                    ($mdgriffith$elm_ui$Internal$Model$floatClass(tz) +
                      ("-" +
                        ($mdgriffith$elm_ui$Internal$Model$floatClass(sx) +
                          ("-" +
                            ($mdgriffith$elm_ui$Internal$Model$floatClass(sy) +
                              ("-" +
                                ($mdgriffith$elm_ui$Internal$Model$floatClass(
                                  sz
                                ) +
                                  ("-" +
                                    ($mdgriffith$elm_ui$Internal$Model$floatClass(
  ...
  var $mdgriffith$elm_ui$Internal$Model$getStyleName = function (style) {
    switch (style.$) {
      ...
      case "GridTemplateStyle":
        ...
        return (
          ...
          (A2(
            ...
            A2(
              $elm$core$List$map,
              $mdgriffith$elm_ui$Internal$Model$lengthClassName,
              template.rows
            )
          ) +
            ("-cols-" +
      ...
      case "GridPosition":
        ...
        return (
          "gp grid-pos-" +
          ($elm$core$String$fromInt(pos.row) +
            ("-" +
              ($elm$core$String$fromInt(pos.col) +
                ("-" +
                  ($elm$core$String$fromInt(pos.width) +
                    ("-" + $elm$core$String$fromInt(pos.height)))))))
        );
      case "PseudoSelector":
  ...
  var $mdgriffith$elm_ui$Internal$Model$reduceStyles = F2(function (
    style,
    nevermind
  ) {
    ...
    return A2($elm$core$Set$member, styleName, cache)
      ? nevermind
      : _Utils_Tuple2(
  ...
  var $mdgriffith$elm_ui$Internal$Model$formatColor = function (_v0) {
    ...
    return (
      "rgba(" +
      ($elm$core$String$fromInt($elm$core$Basics$round(red * 255)) +
        ("," +
          $elm$core$String$fromInt($elm$core$Basics$round(green * 255)) +
          ("," +
            $elm$core$String$fromInt($elm$core$Basics$round(blue * 255)) +
    ...
    return _List_fromArray([
      A2(
        ...
        $mdgriffith$elm_ui$Internal$Style$dot(
          $mdgriffith$elm_ui$Internal$Style$classes.focusedWithin
        ) + ":focus-within",
        A2(
          $elm$core$List$filterMap,
          $elm$core$Basics$identity,
  ...
  var $mdgriffith$elm_ui$Internal$Style$contentName = function (desc) {
    switch (desc.a.$) {
      case "Top":
        var _v1 = desc.a;
        return $mdgriffith$elm_ui$Internal$Style$dot(
          $mdgriffith$elm_ui$Internal$Style$classes.contentTop
        );
      case "Bottom":
        var _v2 = desc.a;
        return $mdgriffith$elm_ui$Internal$Style$dot(
          $mdgriffith$elm_ui$Internal$Style$classes.contentBottom
        );
      case "Right":
        var _v3 = desc.a;
        return $mdgriffith$elm_ui$Internal$Style$dot(
          $mdgriffith$elm_ui$Internal$Style$classes.contentRight
        );
      case "Left":
        var _v4 = desc.a;
        return $mdgriffith$elm_ui$Internal$Style$dot(
          $mdgriffith$elm_ui$Internal$Style$classes.contentLeft
        );
      case "CenterX":
        var _v5 = desc.a;
        return $mdgriffith$elm_ui$Internal$Style$dot(
          $mdgriffith$elm_ui$Internal$Style$classes.contentCenterX
        );
      default:
        var _v6 = desc.a;
        return $mdgriffith$elm_ui$Internal$Style$dot(
  ...
  var $mdgriffith$elm_ui$Internal$Style$selfName = function (desc) {
    switch (desc.a.$) {
      case "Top":
        var _v1 = desc.a;
        return $mdgriffith$elm_ui$Internal$Style$dot(
          $mdgriffith$elm_ui$Internal$Style$classes.alignTop
        );
      case "Bottom":
        var _v2 = desc.a;
        return $mdgriffith$elm_ui$Internal$Style$dot(
          $mdgriffith$elm_ui$Internal$Style$classes.alignBottom
        );
      case "Right":
        var _v3 = desc.a;
        return $mdgriffith$elm_ui$Internal$Style$dot(
          $mdgriffith$elm_ui$Internal$Style$classes.alignRight
        );
      case "Left":
        var _v4 = desc.a;
        return $mdgriffith$elm_ui$Internal$Style$dot(
          $mdgriffith$elm_ui$Internal$Style$classes.alignLeft
        );
      case "CenterX":
        var _v5 = desc.a;
        return $mdgriffith$elm_ui$Internal$Style$dot(
          $mdgriffith$elm_ui$Internal$Style$classes.alignCenterX
        );
      default:
        var _v6 = desc.a;
        return $mdgriffith$elm_ui$Internal$Style$dot(
          $mdgriffith$elm_ui$Internal$Style$classes.alignCenterY
        );
    }
  };
  var $mdgriffith$elm_ui$Internal$Style$describeAlignment = function (values) {
    ...
    return $mdgriffith$elm_ui$Internal$Style$Batch(
      A2(
        ...
        createDescription,
        $mdgriffith$elm_ui$Internal$Style$alignments
      )
    );
  };
  var $mdgriffith$elm_ui$Internal$Style$elDescription = _List_fromArray([
    ...
    A2(
      $mdgriffith$elm_ui$Internal$Style$Descriptor,
      $mdgriffith$elm_ui$Internal$Style$dot(
        $mdgriffith$elm_ui$Internal$Style$classes.hasBehind
      ),
      _List_fromArray([
    ...
    A2(
      $mdgriffith$elm_ui$Internal$Style$Descriptor,
      $mdgriffith$elm_ui$Internal$Style$dot(
        $mdgriffith$elm_ui$Internal$Style$classes.seButton
      ),
      _List_fromArray([
        A2(
          $mdgriffith$elm_ui$Internal$Style$Child,
    ...
    A2(
      $mdgriffith$elm_ui$Internal$Style$Child,
      $mdgriffith$elm_ui$Internal$Style$dot(
        $mdgriffith$elm_ui$Internal$Style$classes.widthFillPortion
      ),
      _List_fromArray([
        A2($mdgriffith$elm_ui$Internal$Style$Prop, "width", "100%"),
      ])
    ...
    A2(
      ...
      _Utils_ap(
        ...
        _Utils_ap(
          ...
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.imageContainer
          )
        )
      ),
      _List_fromArray([
        ...
        $mdgriffith$elm_ui$Internal$Style$Batch(
          (function (fn) {
            return A2(
              $elm$core$List$map,
              fn,
              $mdgriffith$elm_ui$Internal$Style$locations
            );
          })(function (loc) {
            switch (loc.$) {
              case "Above":
    ...
    A2(
      ...
      _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.wrapped
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.noTextSelection
          ),
          _List_fromArray([
            A2(
              $mdgriffith$elm_ui$Internal$Style$Prop,
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.cursorPointer
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.cursorText
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.passPointerEvents
          ),
          _List_fromArray([
            A2(
              $mdgriffith$elm_ui$Internal$Style$Prop,
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.capturePointerEvents
          ),
          _List_fromArray([
            A2(
              $mdgriffith$elm_ui$Internal$Style$Prop,
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.transparent
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.opaque
          ),
          _List_fromArray([
        ...
        A2(
          ...
          $mdgriffith$elm_ui$Internal$Style$dot(
            _Utils_ap(
              $mdgriffith$elm_ui$Internal$Style$classes.hover,
              $mdgriffith$elm_ui$Internal$Style$classes.transparent
            )
          ) + ":hover",
          _List_fromArray([
        ...
        A2(
          ...
          $mdgriffith$elm_ui$Internal$Style$dot(
            _Utils_ap(
              $mdgriffith$elm_ui$Internal$Style$classes.focus,
              $mdgriffith$elm_ui$Internal$Style$classes.transparent
            )
          ) + ":focus",
          _List_fromArray([
        ...
        A2(
          ...
          $mdgriffith$elm_ui$Internal$Style$dot(
            _Utils_ap(
              $mdgriffith$elm_ui$Internal$Style$classes.active,
              $mdgriffith$elm_ui$Internal$Style$classes.transparent
            )
          ) + ":active",
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.transition
          ),
          _List_fromArray([
            A2(
              $mdgriffith$elm_ui$Internal$Style$Prop,
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.scrollbars
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.scrollbarsX
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.scrollbarsY
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.clip
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.clipX
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.clipY
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.borderNone
          ),
          _List_fromArray([
            A2($mdgriffith$elm_ui$Internal$Style$Prop, "border-width", "0"),
          ])
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.borderDashed
          ),
          _List_fromArray([
            A2(
              $mdgriffith$elm_ui$Internal$Style$Prop,
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.borderDotted
          ),
          _List_fromArray([
            A2(
              $mdgriffith$elm_ui$Internal$Style$Prop,
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.borderSolid
          ),
          _List_fromArray([
            A2($mdgriffith$elm_ui$Internal$Style$Prop, "border-style", "solid"),
          ])
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.inputText
          ),
          _List_fromArray([
        ...
        A2(
          ...
          _List_fromArray([
            ...
            A2(
              ...
              _List_fromArray([
                ...
                A2(
                  $mdgriffith$elm_ui$Internal$Style$Descriptor,
                  $mdgriffith$elm_ui$Internal$Style$dot(
                    $mdgriffith$elm_ui$Internal$Style$classes.widthExact
                  ),
                  _List_fromArray([
                    A2(
                      $mdgriffith$elm_ui$Internal$Style$Prop,
                ...
                A2(
                  $mdgriffith$elm_ui$Internal$Style$Descriptor,
                  $mdgriffith$elm_ui$Internal$Style$dot(
                    $mdgriffith$elm_ui$Internal$Style$classes.link
                  ),
                  _List_fromArray([
                    A2(
                      $mdgriffith$elm_ui$Internal$Style$Prop,
            ...
            A2(
              $mdgriffith$elm_ui$Internal$Style$Child,
              $mdgriffith$elm_ui$Internal$Style$dot(
                $mdgriffith$elm_ui$Internal$Style$classes.heightFillPortion
              ),
              _List_fromArray([
                A2(
                  $mdgriffith$elm_ui$Internal$Style$Prop,
            ...
            $mdgriffith$elm_ui$Internal$Style$describeAlignment(function (
              alignment
            ) {
              switch (alignment.$) {
                case "Top":
            ...
            A2(
              $mdgriffith$elm_ui$Internal$Style$Descriptor,
              $mdgriffith$elm_ui$Internal$Style$dot(
                $mdgriffith$elm_ui$Internal$Style$classes.spaceEvenly
              ),
              _List_fromArray([
                A2(
                  $mdgriffith$elm_ui$Internal$Style$Prop,
            ...
            A2(
              $mdgriffith$elm_ui$Internal$Style$Descriptor,
              $mdgriffith$elm_ui$Internal$Style$dot(
                $mdgriffith$elm_ui$Internal$Style$classes.inputLabel
              ),
              _List_fromArray([
                A2(
                  $mdgriffith$elm_ui$Internal$Style$Prop,
            ...
            A2(
              ...
              _List_fromArray([
                ...
                A2(
                  $mdgriffith$elm_ui$Internal$Style$Descriptor,
                  $mdgriffith$elm_ui$Internal$Style$dot(
                    $mdgriffith$elm_ui$Internal$Style$classes.heightExact
                  ),
                  _List_fromArray([
                    A2(
                      $mdgriffith$elm_ui$Internal$Style$Prop,
        ...
        A2(
          ...
          _List_fromArray([
            ...
            A2(
              ...
              _List_fromArray([_Utils_Tuple2("display", "grid")])
            ),
            $mdgriffith$elm_ui$Internal$Style$gridAlignments(function (
              alignment
            ) {
              switch (alignment.$) {
                case "Top":
        ...
        A2(
          ...
          _List_fromArray([
            ...
            A2(
              $mdgriffith$elm_ui$Internal$Style$Child,
              $mdgriffith$elm_ui$Internal$Style$dot(
                $mdgriffith$elm_ui$Internal$Style$classes.any + ":first-child"
              ),
              _List_fromArray([
                A2(
                  $mdgriffith$elm_ui$Internal$Style$Prop,
            ...
            A2(
              ...
              $mdgriffith$elm_ui$Internal$Style$dot(
                $mdgriffith$elm_ui$Internal$Style$classes.any +
                  ($mdgriffith$elm_ui$Internal$Style$selfName(
                    $mdgriffith$elm_ui$Internal$Style$Self(
                      $mdgriffith$elm_ui$Internal$Style$Left
                    )
                  ) +
                    (":first-child + ." +
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.inputMultiline
          ),
          _List_fromArray([
            A2(
              $mdgriffith$elm_ui$Internal$Style$Prop,
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.inputMultilineWrapper
          ),
          _List_fromArray([
            A2(
              $mdgriffith$elm_ui$Internal$Style$Descriptor,
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.inputMultilineParent
          ),
          _List_fromArray([
            A2(
              $mdgriffith$elm_ui$Internal$Style$Prop,
            ...
            A2(
              $mdgriffith$elm_ui$Internal$Style$Child,
              $mdgriffith$elm_ui$Internal$Style$dot(
                $mdgriffith$elm_ui$Internal$Style$classes.inputMultilineFiller
              ),
              _List_fromArray([
                A2(
                  $mdgriffith$elm_ui$Internal$Style$Prop,
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.textThin
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.textExtraLight
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.textLight
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.textNormalWeight
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.textMedium
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.textSemiBold
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.bold
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.textExtraBold
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.textHeavy
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.italic
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.strike
          ),
          _List_fromArray([
            A2(
              $mdgriffith$elm_ui$Internal$Style$Prop,
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.underline
          ),
          _List_fromArray([
            A2(
              $mdgriffith$elm_ui$Internal$Style$Prop,
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.textUnitalicized
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.textJustify
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.textJustifyAll
          ),
          _List_fromArray([
            A2(
              $mdgriffith$elm_ui$Internal$Style$Prop,
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.textCenter
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.textRight
          ),
          _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Internal$Style$Descriptor,
          $mdgriffith$elm_ui$Internal$Style$dot(
            $mdgriffith$elm_ui$Internal$Style$classes.textLeft
          ),
          _List_fromArray([
  ...
  var $mdgriffith$elm_ui$Internal$Style$overrides =
                  ...
                  (" > " +
                    ($mdgriffith$elm_ui$Internal$Style$dot(
                      ...
                      ($mdgriffith$elm_ui$Internal$Style$dot(
                        ...
                        (" { flex-basis: auto !important; }}" +
                          ($mdgriffith$elm_ui$Internal$Style$inputTextReset +
                            ($mdgriffith$elm_ui$Internal$Style$sliderReset +
                              ($mdgriffith$elm_ui$Internal$Style$trackReset +
                                ($mdgriffith$elm_ui$Internal$Style$thumbReset +
                                  $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
  ...
  var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(function (
    selector,
    closing
  ) {
  ...
  var $mdgriffith$elm_ui$Internal$Style$renderRules = F2(function (
    _v0,
    rulesToRender
  ) {
    var parent = _v0.a;
  ...
  var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (
    styleClasses
  ) {
  ...
  var $mdgriffith$elm_ui$Internal$Style$rules = _Utils_ap(
    ...
    $mdgriffith$elm_ui$Internal$Style$renderCompact(
      _Utils_ap(
        $mdgriffith$elm_ui$Internal$Style$baseSheet,
        $mdgriffith$elm_ui$Internal$Style$commonValues
      )
    )
  );
            ...
            A3(
              ...
              _List_fromArray([
                $elm$virtual_dom$VirtualDom$text(
                  $mdgriffith$elm_ui$Internal$Style$rules
                ),
              ])
            ),
          ])
  ...
  var $mdgriffith$elm_ui$Internal$Model$hasSmallCaps = function (typeface) {
    if (typeface.$ === "FontWith") {
      ...
      return A2(
        $elm$core$List$any,
        $mdgriffith$elm_ui$Internal$Model$isSmallCaps,
        font.variants
      );
    } else {
      return false;
  ...
  var $mdgriffith$elm_ui$Internal$Model$renderProps = F3(function (
    force,
    _v0,
    existing
  ) {
  ...
  var $mdgriffith$elm_ui$Internal$Model$renderStyle = F4(function (
    options,
    maybePseudo,
    selector,
    props
    ...
    if (typeface.$ === "FontWith") {
      ...
      return $elm$core$Maybe$Just(
        A2(
          ...
          A2(
            $elm$core$List$map,
            $mdgriffith$elm_ui$Internal$Model$renderVariant,
            font.variants
          )
        )
      );
            ...
            ($elm$core$String$fromFloat(x) +
              ("px, " +
                ($elm$core$String$fromFloat(y) +
                  ("px, " + ($elm$core$String$fromFloat(z) + "px)")))))
        );
      default:
        var _v2 = transform.a;
        var tx = _v2.a;
        ...
        var translate =
          "translate3d(" +
          ($elm$core$String$fromFloat(tx) +
            ("px, " +
              ($elm$core$String$fromFloat(ty) +
                ("px, " + ($elm$core$String$fromFloat(tz) + "px)")))));
        var scale =
          "scale3d(" +
          ($elm$core$String$fromFloat(sx) +
            (", " +
              ($elm$core$String$fromFloat(sy) +
                (", " + ($elm$core$String$fromFloat(sz) + ")")))));
        var rotate =
          "rotate3d(" +
          ($elm$core$String$fromFloat(ox) +
            (", " +
              ($elm$core$String$fromFloat(oy) +
                (", " +
                  ($elm$core$String$fromFloat(oz) +
  ...
  var $mdgriffith$elm_ui$Internal$Model$renderStyleRule = F3(function (
    options,
    rule,
    maybePseudo
  ) {
    switch (rule.$) {
      ...
      case "FontFamily":
        ...
        var features = A2(
          ...
          A2(
            $elm$core$List$filterMap,
            $mdgriffith$elm_ui$Internal$Model$renderVariants,
            typefaces
          )
        );
        var families = _List_fromArray([
          A2(
            ...
            A2(
              ...
              A2(
                $elm$core$List$map,
                $mdgriffith$elm_ui$Internal$Model$fontName,
                typefaces
              )
            )
          ),
          ...
          A2(
            ...
            A2(
              $elm$core$List$any,
              $mdgriffith$elm_ui$Internal$Model$hasSmallCaps,
              typefaces
            )
              ? "small-caps"
              : "normal"
      ...
      case "SpacingStyle":
        ...
        var wrappedRow =
          "." + ($mdgriffith$elm_ui$Internal$Style$classes.wrapped + row);
          ...
          _List_fromArray([
            A2(
              ...
              $elm$core$String$fromFloat(top) +
                ("px " +
                  ($elm$core$String$fromFloat(right) +
                    ("px " +
                      ($elm$core$String$fromFloat(bottom) +
                        ("px " + ($elm$core$String$fromFloat(left) + "px"))))))
            ),
          ])
        );
      case "BorderWidth":
          ...
          _List_fromArray([
            A2(
              ...
              $elm$core$String$fromInt(top) +
                ("px " +
                  ($elm$core$String$fromInt(right) +
                    ("px " +
                      ($elm$core$String$fromInt(bottom) +
                        ("px " + ($elm$core$String$fromInt(left) + "px"))))))
            ),
          ])
        );
      case "GridTemplateStyle":
              ...
              case "Content":
                ...
                if (_v2.a.$ === "Nothing") {
                  ...
                  if (_v2.b.$ === "Nothing") {
                    ...
                    return (
                      "minmax(" +
                      ($elm$core$String$fromInt(minSize) +
                        ("px, " + "max-content)"))
                    );
                  } else {
                    var minSize = _v2.a.a;
                    ...
                    return (
                      "minmax(" +
                      ($elm$core$String$fromInt(minSize) +
                        ("px, " + ($elm$core$String$fromInt(maxSize) + "px)")))
                    );
                  }
                }
              case "Fill":
                ...
                if (_v7.a.$ === "Nothing") {
                  ...
                  if (_v7.b.$ === "Nothing") {
                    ...
                    return (
                      ...
                      ($elm$core$String$fromInt(minSize) +
                        ("px, " +
                          ($elm$core$String$fromInt(i) + ("fr" + "fr)"))))
                    );
                  } else {
                    var minSize = _v7.a.a;
                    var maxSize = _v7.b.a;
        ...
        var gapX =
          "grid-column-gap:" + (toGridLength(template.spacing.a) + ";");
      ...
      case "GridPosition":
        ...
        var msPosition = A2(
          ...
          _List_fromArray([
            ...
            "-ms-grid-row-span: " +
              ($elm$core$String$fromInt(position.height) + ";"),
            "-ms-grid-column: " +
              ($elm$core$String$fromInt(position.col) + ";"),
            "-ms-grid-column-span: " +
              ($elm$core$String$fromInt(position.width) + ";"),
          ])
        );
        var modernPosition = A2(
          ...
          _List_fromArray([
            "grid-row: " +
              ($elm$core$String$fromInt(position.row) +
                (" / " +
                  ($elm$core$String$fromInt(position.row + position.height) +
                    ";"))),
            "grid-column: " +
              ($elm$core$String$fromInt(position.col) +
                (" / " +
                  ($elm$core$String$fromInt(position.col + position.width) +
                    ";"))),
          ])
        );
        var _class =
      ...
      default:
        ...
        var _class =
          $mdgriffith$elm_ui$Internal$Model$transformClass(transform);
  ...
  var $mdgriffith$elm_ui$Internal$Model$encodeStyles = F2(function (
    options,
    stylesheet
  ) {
  ...
  var $mdgriffith$elm_ui$Internal$Model$bracket = F2(function (
    selector,
    rules
  ) {
  ...
  var $mdgriffith$elm_ui$Internal$Model$fontRule = F3(function (
    name,
    modifier,
    _v0
  ) {
  ...
  var $mdgriffith$elm_ui$Internal$Model$renderFontAdjustmentRule = F3(function (
    fontToAdjust,
    _v0,
    otherFontName
  ) {
    var full = _v0.a;
    var capital = _v0.b;
    var name = _Utils_eq(fontToAdjust, otherFontName)
      ? fontToAdjust
    ...
    return A2(
      ...
      _Utils_ap(
        A3(
          $mdgriffith$elm_ui$Internal$Model$fontRule,
          name,
          $mdgriffith$elm_ui$Internal$Style$classes.sizeByCapital,
          capital
        ),
        A3(
          $mdgriffith$elm_ui$Internal$Model$fontRule,
          name,
          $mdgriffith$elm_ui$Internal$Style$classes.fullSize,
          full
        )
      )
    );
  });
  var $mdgriffith$elm_ui$Internal$Model$renderNullAdjustmentRule = F2(function (
    fontToAdjust,
    otherFontName
  ) {
    var name = _Utils_eq(fontToAdjust, otherFontName)
                  ...
                  (", " +
                    ("." +
                      (name +
                        (" ." +
                          $mdgriffith$elm_ui$Internal$Style$classes.sizeByCapital))))))),
          _List_fromArray([_Utils_Tuple2("line-height", "1")])
        ),
        A2(
          $mdgriffith$elm_ui$Internal$Model$bracket,
          "." +
  ...
  var $mdgriffith$elm_ui$Internal$Model$adjust = F3(function (
    size,
    height,
    vertical
  ) {
  ...
  var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (
    adjustment
  ) {
    ...
    return {
      capital: A3(
        $mdgriffith$elm_ui$Internal$Model$adjust,
        capitalSize,
  ...
  var $mdgriffith$elm_ui$Internal$Model$fontAdjustmentRules = function (
    converted
  ) {
    return _Utils_Tuple2(
      _List_fromArray([_Utils_Tuple2("display", "block")]),
      _List_fromArray([
  ...
  var $mdgriffith$elm_ui$Internal$Model$typefaceAdjustment = function (
    typefaces
  ) {
    return A3(
      $elm$core$List$foldl,
      F2(function (face, found) {
        if (found.$ === "Nothing") {
          if (face.$ === "FontWith") {
            var _with = face.a;
                ...
                _Utils_Tuple2(
                  $mdgriffith$elm_ui$Internal$Model$fontAdjustmentRules(
                    (function ($) {
                      ...
                      $mdgriffith$elm_ui$Internal$Model$convertAdjustment(
                        adjustment
                      )
                    )
                  ),
  ...
  var $mdgriffith$elm_ui$Internal$Model$renderTopLevelValues = function (
    rules
  ) {
      ...
      if (_v0.$ === "Nothing") {
        ...
        return A2(
          ...
          A2(
            $elm$core$List$map,
            A2(
              $mdgriffith$elm_ui$Internal$Model$renderFontAdjustmentRule,
              name,
              adjustment
            ),
            allNames
  ...
  var $mdgriffith$elm_ui$Internal$Model$toStyleSheetString = F2(function (
    options,
    stylesheet
  ) {
  ...
  var $mdgriffith$elm_ui$Internal$Model$toStyleSheet = F2(function (
    options,
    styleSheet
  ) {
          ...
          _List_fromArray([
            A3(
              ...
              _List_fromArray([
                $elm$virtual_dom$VirtualDom$text(
                  A2(
                    $mdgriffith$elm_ui$Internal$Model$toStyleSheetString,
                    options,
                    styleSheet
                  )
                ),
        ...
        return A3(
          ...
          _List_fromArray([
            A2(
              ...
              "rules",
              A2(
                $mdgriffith$elm_ui$Internal$Model$encodeStyles,
                options,
                styleSheet
              )
            ),
  ...
  var $mdgriffith$elm_ui$Internal$Model$embedKeyed = F4(function (
    _static,
    opts,
    styles,
    children
  ...
  var $mdgriffith$elm_ui$Internal$Model$embedWith = F4(function (
    _static,
    opts,
    styles,
    children
  ...
  var $mdgriffith$elm_ui$Internal$Flag$heightBetween =
    $mdgriffith$elm_ui$Internal$Flag$flag(45);
  var $mdgriffith$elm_ui$Internal$Flag$heightFill =
    $mdgriffith$elm_ui$Internal$Flag$flag(37);
  ...
  var $mdgriffith$elm_ui$Internal$Flag$widthBetween =
    $mdgriffith$elm_ui$Internal$Flag$flag(44);
  var $mdgriffith$elm_ui$Internal$Flag$widthFill =
    $mdgriffith$elm_ui$Internal$Flag$flag(39);
  var $mdgriffith$elm_ui$Internal$Model$finalizeNode = F6(function (
    has,
    node,
    attributes,
    children,
          ...
          (function () {
            switch (embedMode.$) {
              ...
              case "OnlyDynamic":
                ...
                return A4(
                  $mdgriffith$elm_ui$Internal$Model$embedKeyed,
                  false,
                  opts,
                  styles,
                  keyed
          ...
          (function () {
            switch (embedMode.$) {
              ...
              case "OnlyDynamic":
                ...
                var styles = embedMode.b;
                return A4(
                  $mdgriffith$elm_ui$Internal$Model$embedWith,
                  false,
                  opts,
                  styles,
                  unkeyed
    ...
    switch (parentContext.$) {
      case "AsRow":
        return A2(
          $mdgriffith$elm_ui$Internal$Flag$present,
          $mdgriffith$elm_ui$Internal$Flag$widthFill,
          has
        ) &&
          !A2(
            $mdgriffith$elm_ui$Internal$Flag$present,
            $mdgriffith$elm_ui$Internal$Flag$widthBetween,
            has
          )
          ? html
          : A2(
              $mdgriffith$elm_ui$Internal$Flag$present,
              $mdgriffith$elm_ui$Internal$Flag$alignRight,
              has
            )
          ? A2(
              $elm$html$Html$u,
              ...
              _List_fromArray([html])
            )
          : A2(
              $mdgriffith$elm_ui$Internal$Flag$present,
              $mdgriffith$elm_ui$Internal$Flag$centerX,
              has
            )
          ? A2(
              $elm$html$Html$s,
      ...
      case "AsColumn":
        return A2(
          ...
          !A2(
            $mdgriffith$elm_ui$Internal$Flag$present,
            $mdgriffith$elm_ui$Internal$Flag$heightBetween,
            has
          )
          ? html
          : A2(
              $mdgriffith$elm_ui$Internal$Flag$present,
              $mdgriffith$elm_ui$Internal$Flag$centerY,
              has
            )
          ? A2(
              $elm$html$Html$s,
          ...
          : A2(
              $mdgriffith$elm_ui$Internal$Flag$present,
              $mdgriffith$elm_ui$Internal$Flag$alignBottom,
              has
            )
          ? A2(
              $elm$html$Html$u,
  ...
  var $mdgriffith$elm_ui$Internal$Model$textElementClasses =
    $mdgriffith$elm_ui$Internal$Style$classes.any +
    (" " +
      ($mdgriffith$elm_ui$Internal$Style$classes.text +
        (" " +
  ...
  var $mdgriffith$elm_ui$Internal$Model$textElement = function (str) {
    return A2(
      ...
      _List_fromArray([
        $elm$html$Html$Attributes$class(
          $mdgriffith$elm_ui$Internal$Model$textElementClasses
        ),
      ]),
      _List_fromArray([$elm$html$Html$text(str)])
    );
  };
  var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses =
    $mdgriffith$elm_ui$Internal$Style$classes.any +
    (" " +
      ($mdgriffith$elm_ui$Internal$Style$classes.text +
        (" " +
  ...
  var $mdgriffith$elm_ui$Internal$Model$textElementFill = function (str) {
    return A2(
      ...
      _List_fromArray([
        $elm$html$Html$Attributes$class(
          $mdgriffith$elm_ui$Internal$Model$textElementFillClasses
        ),
      ]),
      _List_fromArray([$elm$html$Html$text(str)])
    );
  };
  var $mdgriffith$elm_ui$Internal$Model$createElement = F3(function (
    context,
    children,
    rendered
  ) {
        ...
        case "Unstyled":
          ...
          return _Utils_eq(
            ...
            ? _Utils_Tuple2(
                A2(
                  $elm$core$List$cons,
                  _Utils_Tuple2(key, html(context)),
                  htmls
                ),
                existingStyles
              )
        ...
        case "Styled":
          ...
          return _Utils_eq(
            ...
            ? _Utils_Tuple2(
                ...
                $elm$core$List$isEmpty(existingStyles)
                  ? styled.styles
        ...
        case "Text":
          ...
          return _Utils_Tuple2(
            A2(
              ...
              _Utils_Tuple2(
                key,
                _Utils_eq(context, $mdgriffith$elm_ui$Internal$Model$asEl)
                  ? $mdgriffith$elm_ui$Internal$Model$textElementFill(str)
                  : $mdgriffith$elm_ui$Internal$Model$textElement(str)
              ),
              htmls
            ),
            existingStyles
      ...
      switch (child.$) {
        case "Unstyled":
          ...
          return _Utils_eq(
            ...
            ? _Utils_Tuple2(
                A2($elm$core$List$cons, html(context), htmls),
                existingStyles
              )
            : _Utils_Tuple2(
                A2($elm$core$List$cons, html(context), htmls),
    ...
    if (children.$ === "Keyed") {
      ...
      var keyed = _v1.a;
      var styles = _v1.b;
      var newStyles = $elm$core$List$isEmpty(styles)
        ? rendered.styles
        : _Utils_ap(rendered.styles, styles);
      if (!newStyles.b) {
        ...
        return $mdgriffith$elm_ui$Internal$Model$Unstyled(
          A5(
            ...
            $mdgriffith$elm_ui$Internal$Model$Unkeyed(
              A2(
                $mdgriffith$elm_ui$Internal$Model$addChildren,
                unkeyed,
                rendered.children
              )
            ),
  ...
  var $mdgriffith$elm_ui$Internal$Model$ChildrenBehindAndInFront = F2(function (
    a,
    b
  ) {
  ...
  var $mdgriffith$elm_ui$Internal$Model$nearbyElement = F2(function (
    location,
    elem
  ) {
    return A2(
  ...
  var $mdgriffith$elm_ui$Internal$Model$addNearbyElement = F3(function (
    location,
    elem,
    existing
  ) {
    var nearby = A2(
      $mdgriffith$elm_ui$Internal$Model$nearbyElement,
      location,
      elem
    );
    switch (existing.$) {
  ...
  var $mdgriffith$elm_ui$Internal$Model$addNodeName = F2(function (
    newNode,
    old
  ) {
    switch (old.$) {
  ...
  var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
    switch (align.$) {
      case "Left":
        return (
          $mdgriffith$elm_ui$Internal$Style$classes.alignedHorizontally +
          (" " + $mdgriffith$elm_ui$Internal$Style$classes.alignLeft)
        );
      case "Right":
        return (
  ...
  var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
    switch (align.$) {
      case "Top":
        return (
          $mdgriffith$elm_ui$Internal$Style$classes.alignedVertically +
          (" " + $mdgriffith$elm_ui$Internal$Style$classes.alignTop)
        );
      case "Bottom":
        return (
  ...
  var $mdgriffith$elm_ui$Internal$Model$FullTransform = F4(function (
    a,
    b,
    c,
    d
  ...
  var $mdgriffith$elm_ui$Internal$Model$composeTransformation = F2(function (
    transform,
    component
  ) {
    switch (transform.$) {
  ...
  var $mdgriffith$elm_ui$Internal$Flag$height =
    $mdgriffith$elm_ui$Internal$Flag$flag(7);
  var $mdgriffith$elm_ui$Internal$Flag$heightContent =
    $mdgriffith$elm_ui$Internal$Flag$flag(36);
  ...
  var $mdgriffith$elm_ui$Internal$Flag$none = A2(
    $mdgriffith$elm_ui$Internal$Flag$Field,
    0,
    0
  );
  ...
  var $mdgriffith$elm_ui$Internal$Flag$widthContent =
    $mdgriffith$elm_ui$Internal$Flag$flag(38);
  ...
  var $mdgriffith$elm_ui$Internal$Flag$borderWidth =
    $mdgriffith$elm_ui$Internal$Flag$flag(27);
  ...
  var $mdgriffith$elm_ui$Internal$Flag$width =
    $mdgriffith$elm_ui$Internal$Flag$flag(6);
  var $mdgriffith$elm_ui$Internal$Flag$xAlign =
    $mdgriffith$elm_ui$Internal$Flag$flag(30);
  var $mdgriffith$elm_ui$Internal$Flag$yAlign =
    $mdgriffith$elm_ui$Internal$Flag$flag(29);
  var $mdgriffith$elm_ui$Internal$Model$gatherAttrRecursive = F8(function (
    classes,
    node,
    has,
    transform,
        ...
        switch (attribute.$) {
          ...
          case "StyleClass":
            ...
            if (A2($mdgriffith$elm_ui$Internal$Flag$present, flag, has)) {
              ...
              if (
                A2($mdgriffith$elm_ui$Internal$Model$skippable, flag, style)
              ) {
                var $temp$classes =
                    $mdgriffith$elm_ui$Internal$Model$getStyleName(style) +
                    (" " + classes),
          ...
          case "TransformComponent":
            ...
            var $temp$classes = classes,
              ...
              $temp$has = A2($mdgriffith$elm_ui$Internal$Flag$add, flag, has),
              $temp$transform = A2(
                $mdgriffith$elm_ui$Internal$Model$composeTransformation,
                transform,
                component
              ),
              $temp$styles = styles,
          ...
          case "Width":
            ...
            if (
              A2(
                $mdgriffith$elm_ui$Internal$Flag$present,
                $mdgriffith$elm_ui$Internal$Flag$width,
                has
              )
            ) {
              var $temp$classes = classes,
              ...
              switch (width.$) {
                  ...
                  if (portion === 1) {
                    ...
                    var $temp$classes =
                        ...
                        (" " +
                          ($mdgriffith$elm_ui$Internal$Style$classes.widthFillPortion +
                            (" width-fill-" +
                              $elm$core$String$fromInt(portion)))),
                      $temp$node = node,
                      $temp$has = A2(
                        $mdgriffith$elm_ui$Internal$Flag$add,
                        $mdgriffith$elm_ui$Internal$Flag$widthFill,
                ...
                default:
                  var _v4 =
                    $mdgriffith$elm_ui$Internal$Model$renderWidth(width);
          ...
          case "Height":
            ...
            if (
              ...
              switch (height.$) {
                ...
                default:
                  var _v6 =
                    $mdgriffith$elm_ui$Internal$Model$renderHeight(height);
          ...
          case "Nearby":
            ...
            var $temp$classes = classes,
              ...
              $temp$attrs = attrs,
              $temp$children = A3(
                $mdgriffith$elm_ui$Internal$Model$addNearbyElement,
                location,
                elem,
                children
              ),
          ...
          case "AlignX":
            ...
            if (
              ...
              var $temp$classes =
                  $mdgriffith$elm_ui$Internal$Model$alignXName(x) +
                  (" " + classes),
                $temp$node = node,
          ...
          default:
            ...
            if (
              A2(
                $mdgriffith$elm_ui$Internal$Flag$present,
                $mdgriffith$elm_ui$Internal$Flag$yAlign,
                has
              )
            ) {
              var $temp$classes = classes,
              ...
              var $temp$classes =
                  $mdgriffith$elm_ui$Internal$Model$alignYName(y) +
                  (" " + classes),
                $temp$node = node,
                $temp$has = (function (flags) {
                  switch (y.$) {
  ...
  var $mdgriffith$elm_ui$Internal$Model$element = F4(function (
    context,
    node,
    attributes,
    children
  ...
  var $mdgriffith$elm_ui$Element$height =
    $mdgriffith$elm_ui$Internal$Model$Height;
  ...
  var $mdgriffith$elm_ui$Element$shrink =
    $mdgriffith$elm_ui$Internal$Model$Content;
  var $mdgriffith$elm_ui$Internal$Model$Width = function (a) {
    return { $: "Width", a: a };
  };
  var $mdgriffith$elm_ui$Element$width =
    $mdgriffith$elm_ui$Internal$Model$Width;
  ...
  var $mdgriffith$elm_ui$Internal$Flag$transparency =
    $mdgriffith$elm_ui$Internal$Flag$flag(0);
  var $mdgriffith$elm_ui$Element$alpha = function (o) {
    ...
    return A2(
      ...
      A2(
        ...
        "transparency-" +
          $mdgriffith$elm_ui$Internal$Model$floatClass(transparency),
        transparency
      )
    );
  };
  ...
  var $mdgriffith$elm_ui$Element$fill =
    $mdgriffith$elm_ui$Internal$Model$Fill(1);
  ...
  var $mdgriffith$elm_ui$Element$inFront = function (element) {
    return A2(
      $mdgriffith$elm_ui$Element$createNearby,
      $mdgriffith$elm_ui$Internal$Model$InFront,
      element
    );
  };
  ...
  var $mdgriffith$elm_ui$Element$rgb255 = F3(function (red, green, blue) {
    return A4(
      $mdgriffith$elm_ui$Internal$Model$Rgba,
      red / 255,
      green / 255,
      blue / 255,
      1
  ...
  var $author$project$Main$theme = {
    bgColor: $author$project$Main$colorPalette.richBlack,
    buttonBgColor: $author$project$Main$colorPalette.raisinBlackLight,
    buttonBgColorAlt: $author$project$Main$colorPalette.spaceCadet,
    buttonBgHover: $author$project$Main$colorPalette.combuGreen,
    buttonBgHoverAlt: $author$project$Main$colorPalette.englishViolet,
    contentBgColor: $author$project$Main$colorPalette.raisinBlack,
    contentBgColorDarker: $author$project$Main$colorPalette.smokeyBlack,
    contentBgColorLighter: $author$project$Main$colorPalette.blackCoffee,
    fontColor: $author$project$Main$colorPalette.gainsboro,
    fontColorLighter: $author$project$Main$colorPalette.culturedWhite,
    textSize: 16,
  };
  var $author$project$Main$DeselectRadical = { $: "DeselectRadical" };
  var $mdgriffith$elm_ui$Internal$Model$Class = F2(function (a, b) {
    return { $: "Class", a: a, b: b };
  });
  var $mdgriffith$elm_ui$Internal$Flag$fontAlignment =
    $mdgriffith$elm_ui$Internal$Flag$flag(12);
  var $mdgriffith$elm_ui$Element$Font$alignLeft = A2(
    $mdgriffith$elm_ui$Internal$Model$Class,
    $mdgriffith$elm_ui$Internal$Flag$fontAlignment,
    $mdgriffith$elm_ui$Internal$Style$classes.textLeft
  );
  var $mdgriffith$elm_ui$Element$Font$alignRight = A2(
    $mdgriffith$elm_ui$Internal$Model$Class,
    $mdgriffith$elm_ui$Internal$Flag$fontAlignment,
    $mdgriffith$elm_ui$Internal$Style$classes.textRight
  );
  ...
  var $elm$html$Html$Attributes$disabled =
    $elm$html$Html$Attributes$boolProperty("disabled");
  var $mdgriffith$elm_ui$Element$Input$enter = "Enter";
  var $mdgriffith$elm_ui$Element$Input$hasFocusStyle = function (attr) {
    if (
      attr.$ === "StyleClass" &&
      attr.b.$ === "PseudoSelector" &&
      attr.b.a.$ === "Focus"
    ) {
      var _v1 = attr.b;
      var _v2 = _v1.a;
  ...
  var $mdgriffith$elm_ui$Element$Input$focusDefault = function (attrs) {
    return A2(
      $elm$core$List$any,
      $mdgriffith$elm_ui$Element$Input$hasFocusStyle,
      attrs
    )
  ...
  var $mdgriffith$elm_ui$Element$Events$onClick = A2(
  ...
  var $mdgriffith$elm_ui$Internal$Flag$cursor =
    $mdgriffith$elm_ui$Internal$Flag$flag(21);
  var $mdgriffith$elm_ui$Element$pointer = A2(
    $mdgriffith$elm_ui$Internal$Model$Class,
    $mdgriffith$elm_ui$Internal$Flag$cursor,
    $mdgriffith$elm_ui$Internal$Style$classes.cursorPointer
  );
          ...
          A2(
            ...
            A2(
              ...
              A2(
                ...
                A2(
                  $elm$core$List$cons,
                  $mdgriffith$elm_ui$Internal$Model$Describe(
                    $mdgriffith$elm_ui$Internal$Model$Button
                  ),
                  A2(
                    $elm$core$List$cons,
                    $mdgriffith$elm_ui$Internal$Model$Attr(
                          ...
                          A2(
                            ...
                            $mdgriffith$elm_ui$Element$Input$onKeyLookup(
                              function (code) {
                                return _Utils_eq(
                                  code,
                                  $mdgriffith$elm_ui$Element$Input$enter
                                )
                                  ? $elm$core$Maybe$Just(msg)
                                  : _Utils_eq(
                                      code,
                                      $mdgriffith$elm_ui$Element$Input$space
                                    )
                                  ? $elm$core$Maybe$Just(msg)
                                  : $elm$core$Maybe$Nothing;
                              }
  ...
  var $mdgriffith$elm_ui$Element$centerX =
    $mdgriffith$elm_ui$Internal$Model$AlignX(
      $mdgriffith$elm_ui$Internal$Model$CenterX
    );
  var $mdgriffith$elm_ui$Internal$Model$AlignY = function (a) {
    return { $: "AlignY", a: a };
  };
  var $mdgriffith$elm_ui$Internal$Model$CenterY = { $: "CenterY" };
  var $mdgriffith$elm_ui$Element$centerY =
    $mdgriffith$elm_ui$Internal$Model$AlignY(
      $mdgriffith$elm_ui$Internal$Model$CenterY
    );
  ...
  var $mdgriffith$elm_ui$Element$el = F2(function (attrs, child) {
    return A4(
      ...
      $mdgriffith$elm_ui$Internal$Model$Unkeyed(_List_fromArray([child]))
    );
  });
  var $mdgriffith$elm_ui$Internal$Flag$fontWeight =
    $mdgriffith$elm_ui$Internal$Flag$flag(13);
  var $mdgriffith$elm_ui$Element$Font$extraLight = A2(
    $mdgriffith$elm_ui$Internal$Model$Class,
    $mdgriffith$elm_ui$Internal$Flag$fontWeight,
    $mdgriffith$elm_ui$Internal$Style$classes.textExtraLight
  );
  var $mdgriffith$elm_ui$Element$fillPortion =
    $mdgriffith$elm_ui$Internal$Model$Fill;
  ...
  var $mdgriffith$elm_ui$Internal$Model$PaddingStyle = F5(function (
    a,
    b,
    c,
    d,
  ...
  var $mdgriffith$elm_ui$Internal$Flag$padding =
    $mdgriffith$elm_ui$Internal$Flag$flag(2);
  ...
  var $mdgriffith$elm_ui$Internal$Model$paddingName = F4(function (
    top,
    right,
    bottom,
    left
    ...
    if (
      ...
      return A2(
        ...
        A5(
          $mdgriffith$elm_ui$Internal$Model$PaddingStyle,
          A4(
            $mdgriffith$elm_ui$Internal$Model$paddingName,
            top,
            right,
            bottom,
            left
  ...
  var $mdgriffith$elm_ui$Internal$Flag$borderRound =
    $mdgriffith$elm_ui$Internal$Flag$flag(17);
  var $mdgriffith$elm_ui$Element$Border$roundEach = function (_v0) {
    ...
    return A2(
      ...
      A3(
        $mdgriffith$elm_ui$Internal$Model$Single,
        "br-" +
          ($elm$core$String$fromInt(topLeft) +
            ("-" +
              ($elm$core$String$fromInt(topRight) +
                ($elm$core$String$fromInt(bottomLeft) +
                  ("-" + $elm$core$String$fromInt(bottomRight)))))),
        "border-radius",
        $elm$core$String$fromInt(topLeft) +
          ("px " +
            ($elm$core$String$fromInt(topRight) +
              ("px " +
                ($elm$core$String$fromInt(bottomRight) +
                  ("px " + ($elm$core$String$fromInt(bottomLeft) + "px"))))))
      )
    );
  };
  ...
  var $mdgriffith$elm_ui$Internal$Flag$fontSize =
    $mdgriffith$elm_ui$Internal$Flag$flag(4);
  ...
  var $mdgriffith$elm_ui$Internal$Flag$spacing =
    $mdgriffith$elm_ui$Internal$Flag$flag(3);
  ...
  var $mdgriffith$elm_ui$Element$alignRight =
    $mdgriffith$elm_ui$Internal$Model$AlignX(
      $mdgriffith$elm_ui$Internal$Model$Right
    );
  var $mdgriffith$elm_ui$Internal$Model$Hover = { $: "Hover" };
  var $mdgriffith$elm_ui$Internal$Model$PseudoSelector = F2(function (a, b) {
    return { $: "PseudoSelector", a: a, b: b };
  });
  var $mdgriffith$elm_ui$Internal$Flag$hover =
    $mdgriffith$elm_ui$Internal$Flag$flag(33);
  var $mdgriffith$elm_ui$Internal$Model$TransformComponent = F2(function (
    a,
    b
  ) {
  ...
  var $mdgriffith$elm_ui$Internal$Model$mapAttrFromStyle = F2(function (
    fn,
    attr
  ) {
    switch (attr.$) {
  ...
  var $mdgriffith$elm_ui$Internal$Model$removeNever = function (style) {
    return A2(
      $mdgriffith$elm_ui$Internal$Model$mapAttrFromStyle,
      $elm$core$Basics$never,
      style
    );
  };
  var $mdgriffith$elm_ui$Internal$Model$unwrapDecsHelper = F2(function (
    attr,
    _v0
  ) {
    var styles = _v0.a;
  ...
  var $author$project$Main$titleBarButtonStyles = _List_fromArray([
    $mdgriffith$elm_ui$Element$padding(25),
    $mdgriffith$elm_ui$Element$alignRight,
    $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
    $mdgriffith$elm_ui$Element$Background$color(
      $author$project$Main$theme.contentBgColor
    ),
    $mdgriffith$elm_ui$Element$mouseOver(
      _List_fromArray([
        $mdgriffith$elm_ui$Element$Background$color(
          $author$project$Main$theme.contentBgColorLighter
        ),
        $mdgriffith$elm_ui$Element$Font$color(
          $author$project$Main$theme.fontColorLighter
        ),
      ])
    ),
  ]);
  var $mdgriffith$elm_ui$Element$Font$bold = A2(
    $mdgriffith$elm_ui$Internal$Model$Class,
    $mdgriffith$elm_ui$Internal$Flag$fontWeight,
    $mdgriffith$elm_ui$Internal$Style$classes.bold
  );
  var $author$project$Main$viewRadicalAttribute = F2(function (
    attribute,
    value
  ) {
    return A2(
      ...
      _List_fromArray([
        ...
        A2(
          $mdgriffith$elm_ui$Element$el,
          _List_fromArray([$mdgriffith$elm_ui$Element$centerY]),
          $mdgriffith$elm_ui$Element$text(value)
        ),
      ])
    );
  });
  var $author$project$Main$viewSelectedRadical = function (soundComponent) {
    return A2(
      ...
      _List_fromArray([
        A2(
          ...
          _List_fromArray([
            ...
            $mdgriffith$elm_ui$Element$Background$color(
              $author$project$Main$theme.contentBgColorDarker
            ),
            $mdgriffith$elm_ui$Element$alpha(1),
          ...
          _List_fromArray([
            A2(
              ...
              _Utils_ap(
                $author$project$Main$titleBarButtonStyles,
                _List_fromArray([
                  $mdgriffith$elm_ui$Element$Border$roundEach({
                    bottomLeft: 0,
                    bottomRight: 0,
              ...
              ),
              {
                ...
                onPress: $elm$core$Maybe$Just(
                  $author$project$Main$DeselectRadical
                ),
              }
            ),
          ])
          ...
          _List_fromArray([
            A2(
              ...
              $mdgriffith$elm_ui$Element$text(
                $elm$core$String$fromChar(soundComponent.soundComponent)
              )
            ),
            A2(
              $mdgriffith$elm_ui$Element$column,
              ...
              _List_fromArray([
                A2(
                  $author$project$Main$viewRadicalAttribute,
                  "名前",
                  soundComponent.name
                ),
                A2(
                  $author$project$Main$viewRadicalAttribute,
                  "意味",
                  $author$project$Meaning$displayMeaning(soundComponent.meaning)
                ),
                A2(
                  $author$project$Main$viewRadicalAttribute,
                  "部分",
                  $author$project$Part$getJapanesePartName(soundComponent.part)
                ),
              ])
            ),
          ])
  ...
  var $author$project$Main$viewPopup = function (soundComponent) {
    return A2(
      $mdgriffith$elm_ui$Element$column,
      _List_fromArray([
        $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
        ...
        $mdgriffith$elm_ui$Element$Background$color(
          $author$project$Main$theme.bgColor
        ),
        $mdgriffith$elm_ui$Element$inFront(
          $author$project$Main$viewSelectedRadical(soundComponent)
        ),
      ]),
      _List_Nil
    );
  };
  var $author$project$Main$displaySelectedRadical = function (selected) {
    if (selected.$ === "Just") {
      var soundComponent = selected.a;
      return $author$project$Main$viewPopup(soundComponent);
    } else {
  ...
  var $mdgriffith$elm_ui$Internal$Flag$fontFamily =
    $mdgriffith$elm_ui$Internal$Flag$flag(5);
  var $elm$core$String$toLower = _String_toLower;
  var $elm$core$String$words = _String_words;
  var $mdgriffith$elm_ui$Internal$Model$renderFontClassName = F2(function (
    font,
    current
  ) {
    return _Utils_ap(
        ...
        switch (font.$) {
          ...
          case "Typeface":
            ...
            return A2(
              $elm$core$String$join,
              "-",
              $elm$core$String$words($elm$core$String$toLower(name))
            );
          case "ImportFont":
            var name = font.a;
            var url = font.b;
  ...
  var $mdgriffith$elm_ui$Element$Font$family = function (families) {
    return A2(
      ...
      A2(
        ...
        A3(
          $elm$core$List$foldl,
          $mdgriffith$elm_ui$Internal$Model$renderFontClassName,
          "ff-",
          families
        ),
        families
  ...
  var $author$project$Main$focusBoxShadow = {
    blur: 8,
    color: $author$project$Main$theme.contentBgColorDarker,
  ...
  var $mdgriffith$elm_ui$Element$focusStyle =
    $mdgriffith$elm_ui$Internal$Model$FocusStyleOption;
  var $mdgriffith$elm_ui$Element$Font$justify = A2(
    $mdgriffith$elm_ui$Internal$Model$Class,
    $mdgriffith$elm_ui$Internal$Flag$fontAlignment,
    $mdgriffith$elm_ui$Internal$Style$classes.textJustify
  );
  ...
  var $mdgriffith$elm_ui$Internal$Model$StaticRootAndDynamic = F2(function (
    a,
    b
  ) {
  ...
  var $mdgriffith$elm_ui$Internal$Model$renderRoot = F3(function (
    optionList,
    attributes,
    child
  ) {
    ...
    return _List_fromArray([
      A2(
        ...
        A3(
          $mdgriffith$elm_ui$Internal$Model$Colored,
          "bg-" +
            $mdgriffith$elm_ui$Internal$Model$formatColorClass(
  ...
  var $mdgriffith$elm_ui$Element$Font$regular = A2(
    $mdgriffith$elm_ui$Internal$Model$Class,
    $mdgriffith$elm_ui$Internal$Flag$fontWeight,
    $mdgriffith$elm_ui$Internal$Style$classes.textNormalWeight
  );
  var $author$project$Pages$supportCopy =
    '# About Learning Japanese\n        \n<a href="https://donorbox.org/sashinexists">Donate Text or Image HTML</a>\n    ';
  var $author$project$Pages$support = {
    content: $author$project$Pages$supportCopy,
    route: $author$project$Routes$Support,
    title: "❤",
  };
  var $mdgriffith$elm_ui$Element$Font$typeface =
    $mdgriffith$elm_ui$Internal$Model$Typeface;
  var $mdgriffith$elm_ui$Element$Font$light = A2(
    $mdgriffith$elm_ui$Internal$Model$Class,
    $mdgriffith$elm_ui$Internal$Flag$fontWeight,
    $mdgriffith$elm_ui$Internal$Style$classes.textLight
  );
  ...
  var $author$project$Main$DisplayBy = function (a) {
    return { $: "DisplayBy", a: a };
  };
  var $author$project$Main$ListByPart = { $: "ListByPart" };
  var $author$project$Main$NoCategories = { $: "NoCategories" };
  var $author$project$Main$FilterButton = { $: "FilterButton" };
  var $mdgriffith$elm_ui$Element$Font$center = A2(
    $mdgriffith$elm_ui$Internal$Model$Class,
    $mdgriffith$elm_ui$Internal$Flag$fontAlignment,
    $mdgriffith$elm_ui$Internal$Style$classes.textCenter
  );
  ...
  var $author$project$Main$viewHeaderButton = F3(function (
    label,
    action,
    buttonType
  ) {
    var _v0 = (function () {
      if (buttonType.$ === "FilterButton") {
        return _Utils_Tuple2(
          $author$project$Main$theme.buttonBgColor,
          $author$project$Main$theme.buttonBgHover
        );
      } else {
        return _Utils_Tuple2(
          $author$project$Main$theme.buttonBgColorAlt,
          $author$project$Main$theme.buttonBgHoverAlt
        );
      }
    })();
    var bg = _v0.a;
    ...
    return A2(
      ...
      _List_fromArray([
        ...
        $mdgriffith$elm_ui$Element$mouseOver(
          _List_fromArray([
            $mdgriffith$elm_ui$Element$Background$color(bgHover),
            $mdgriffith$elm_ui$Element$Font$color(
              $author$project$Main$theme.fontColorLighter
            ),
          ])
  ...
  var $author$project$Main$viewInactiveHeaderButton = function (label) {
    return A2(
      $mdgriffith$elm_ui$Element$el,
      _List_fromArray([
        $mdgriffith$elm_ui$Element$Background$color(
  ...
  var $author$project$Main$displayHeaderButton = F3(function (
    label,
    action,
    display
  ) {
    switch (display.$) {
      case "ListBySubject":
        if (action.$ === "DisplayBy" && action.a.$ === "ListBySubject") {
          var _v2 = action.a;
          return $author$project$Main$viewInactiveHeaderButton(label);
        } else {
          return A3(
            $author$project$Main$viewHeaderButton,
            label,
            action,
            $author$project$Main$FilterButton
          );
        }
      case "ListByPart":
        if (action.$ === "DisplayBy" && action.a.$ === "ListByPart") {
          var _v4 = action.a;
          return $author$project$Main$viewInactiveHeaderButton(label);
        } else {
          return A3(
      ...
      default:
        if (action.$ === "DisplayBy" && action.a.$ === "NoCategories") {
          var _v6 = action.a;
          return $author$project$Main$viewInactiveHeaderButton(label);
        } else {
          return A3(
  ...
  var $author$project$Main$viewFilterButtons = function (display) {
    return A2(
      $mdgriffith$elm_ui$Element$row,
      _List_fromArray([$mdgriffith$elm_ui$Element$spacing(20)]),
      _List_fromArray([
        A3(
          $author$project$Main$displayHeaderButton,
          "主題",
          $author$project$Main$DisplayBy($author$project$Main$ListBySubject),
          display
        ),
        A3(
          $author$project$Main$displayHeaderButton,
          "部分",
          $author$project$Main$DisplayBy($author$project$Main$ListByPart),
          display
        ),
        A3(
          $author$project$Main$displayHeaderButton,
          "全部",
          $author$project$Main$DisplayBy($author$project$Main$NoCategories),
          display
        ),
      ])
    );
  ...
  var $author$project$Pages$pages = _List_fromArray([
    $author$project$Pages$about,
    $author$project$Pages$support,
  ]);
  ...
  var $author$project$Main$viewHeaderLink = F2(function (label, url) {
    return A2(
  ...
  var $author$project$Main$viewHeaderLinks = A2(
    $mdgriffith$elm_ui$Element$row,
    _List_fromArray([
    ...
    A2(
      ...
      function (p) {
        return A2(
          $author$project$Main$viewHeaderLink,
          p.title,
  ...
  var $author$project$Main$viewSiteTitle =
    $mdgriffith$elm_ui$Element$text("漢字の部首学ぶ教室へようこそ！！");
  var $author$project$Main$viewHeader = function (display) {
    return A2(
      ...
      _List_fromArray([
        ...
        $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
        $mdgriffith$elm_ui$Element$alignRight,
        $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$px(70)),
      ]),
      _List_fromArray([
  ...
  var $author$project$Main$viewRadical = function (soundComponent) {
    return A2(
      $mdgriffith$elm_ui$Element$Input$button,
      _List_fromArray([
        $mdgriffith$elm_ui$Element$Background$color(
        ...
        $mdgriffith$elm_ui$Element$Border$rounded(10),
        $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$px(320)),
        ...
        label: A2(
          ...
          _List_fromArray([
            ...
            A2(
              ...
              $mdgriffith$elm_ui$Element$text(soundComponent.name)
            ),
          ])
        ),
        onPress: $elm$core$Maybe$Just(
          $author$project$Main$SelectRadical(soundComponent)
        ),
      }
    );
  };
  ...
  var $mdgriffith$elm_ui$Internal$Model$extractSpacingAndPadding = function (
    attrs
  ) {
    return A3(
      $elm$core$List$foldr,
      F2(function (attr, _v0) {
        var pad = _v0.a;
        var spacing = _v0.b;
        return _Utils_Tuple2(
          (function () {
            if (pad.$ === "Just") {
              ...
              if (attr.$ === "StyleClass" && attr.b.$ === "PaddingStyle") {
                ...
                return $elm$core$Maybe$Just(
                  A5(
                    $mdgriffith$elm_ui$Internal$Model$Padding,
                    name,
                    t,
                    r,
                    b,
  ...
  var $mdgriffith$elm_ui$Internal$Model$paddingNameFloat = F4(function (
    top,
    right,
    bottom,
    left
    ...
    return (
      "pad-" +
      ($mdgriffith$elm_ui$Internal$Model$floatClass(top) +
        ("-" +
          ($mdgriffith$elm_ui$Internal$Model$floatClass(right) +
            ("-" +
              ($mdgriffith$elm_ui$Internal$Model$floatClass(bottom) +
                ("-" + $mdgriffith$elm_ui$Internal$Model$floatClass(left)))))))
    );
  });
            ...
            return $elm$core$Maybe$Just(
              A2(
                ...
                A5(
                  $mdgriffith$elm_ui$Internal$Model$PaddingStyle,
                  A4(
                    $mdgriffith$elm_ui$Internal$Model$paddingNameFloat,
                    newTop,
                    newRight,
                    newBottom,
                    newLeft
          ...
          A2(
            ...
            A2(
              ...
              A2(
                ...
                _Utils_ap(attrs, _List_fromArray([pad]))
              )
            )
          ),
          $mdgriffith$elm_ui$Internal$Model$Unkeyed(children)
                  ...
                  A2(
                    ...
                    $mdgriffith$elm_ui$Internal$Model$Attr(
                      A2(
                        ...
                        "margin",
                        $elm$core$String$fromFloat(halfY) +
                          ("px" +
                            (" " + ($elm$core$String$fromFloat(halfX) + "px")))
                      )
                    ),
                    A2(
                      $elm$core$List$cons,
  ...
  var $author$project$Main$viewPartRadicals = F2(function (radicals, part) {
    return A2(
      $mdgriffith$elm_ui$Element$column,
      _List_fromArray([
        $mdgriffith$elm_ui$Element$paddingEach({
  ...
  var $author$project$Main$viewSubjectRadicals = F2(function (
    radicals,
    subject
  ) {
    return A2(
  ...
  var $mdgriffith$elm_ui$Internal$Model$unstyled = A2(
    $elm$core$Basics$composeL,
    $mdgriffith$elm_ui$Internal$Model$Unstyled,
    $elm$core$Basics$always
  );
  var $mdgriffith$elm_ui$Element$html =
    $mdgriffith$elm_ui$Internal$Model$unstyled;
  var $author$project$Main$markdownOptions = {
    defaultHighlighting: $elm$core$Maybe$Nothing,
    githubFlavored: $elm$core$Maybe$Just({ breaks: true, tables: true }),
    sanitize: false,
    smartypants: true,
  };
      ...
      body: _List_fromArray([
        A3(
            ...
            options: _List_fromArray([
              $mdgriffith$elm_ui$Element$focusStyle(
                A3(
                  ...
                  $elm$core$Maybe$Just($author$project$Main$focusBoxShadow)
                )
              ),
            ]),
          },
          _List_fromArray([
            ...
            $mdgriffith$elm_ui$Element$Font$color(
              $author$project$Main$theme.fontColor
            ),
            $mdgriffith$elm_ui$Element$Font$size(
              $author$project$Main$theme.textSize
            ),
            ...
            $mdgriffith$elm_ui$Element$inFront(
              $author$project$Main$displaySelectedRadical(model.selected)
            ),
          ]),
          A2(
            $mdgriffith$elm_ui$Element$column,
            ...
            _List_fromArray([
              ...
              (function () {
                ...
                switch (_v0.$) {
                  case "Home":
                    return $author$project$Main$viewHomeRoute(model);
                  case "About":
                    return $author$project$Main$viewPage(
                      $author$project$Pages$about
                    );
                  default:
                    return $author$project$Main$viewPage(
