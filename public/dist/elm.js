...
var $author$project$Radical$Radical = F7(
	function (radical, name, meaning, alternates, part, examples, subject) {
		return {alternates: alternates, examples: examples, meaning: meaning, name: name, part: part, radical: radical, subject: subject};
	});
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		var model = {display: $author$project$Main$ListBySubject, key: key, radicals: $author$project$Radicals$radicals, route: $author$project$Routes$Home, selected: $elm$core$Maybe$Nothing, url: url};
		return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
	});
...
var $author$project$Main$keyDownListener = A2($elm$json$Json$Decode$map, $author$project$Main$KeyDown, $author$project$Main$decodeKey);
...
var $author$project$Main$theme = {bgColor: $author$project$Main$colorPalette.richBlack, buttonBgColor: $author$project$Main$colorPalette.raisinBlackLight, buttonBgColorAlt: $author$project$Main$colorPalette.spaceCadet, buttonBgHover: $author$project$Main$colorPalette.combuGreen, buttonBgHoverAlt: $author$project$Main$colorPalette.englishViolet, contentBgColor: $author$project$Main$colorPalette.raisinBlack, contentBgColorDarker: $author$project$Main$colorPalette.smokeyBlack, contentBgColorLighter: $author$project$Main$colorPalette.blackCoffee, fontColor: $author$project$Main$colorPalette.gainsboro, fontColorLighter: $author$project$Main$colorPalette.culturedWhite, textSize: 16};
...
var $author$project$Main$titleBarButtonStyles = _List_fromArray(
	[
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color($author$project$Main$theme.contentBgColorLighter),
				$mdgriffith$elm_ui$Element$Font$color($author$project$Main$theme.fontColorLighter)
			]))
	]);
var $mdgriffith$elm_ui$Element$Font$bold = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.bold);
var $author$project$Main$viewRadicalAttribute = F2(
...
var $author$project$Main$viewSelectedRadical = function (radical) {
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$Background$color($author$project$Main$theme.contentBgColorDarker),
						$mdgriffith$elm_ui$Element$alpha(1),
				...
				_List_fromArray(
					[
								...
								])),
						{
							...
							onPress: $elm$core$Maybe$Just($author$project$Main$DeselectRadical)
						})
					])),
				A2(
				$mdgriffith$elm_ui$Element$row,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($author$project$Main$viewRadicalAttribute, '名前', radical.name),
								A2(
...
var $author$project$Main$viewPopup = function (radical) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Background$color($author$project$Main$theme.bgColor),
				$mdgriffith$elm_ui$Element$inFront(
				$author$project$Main$viewSelectedRadical(radical))
			]),
		_List_Nil);
};
var $author$project$Main$displaySelectedRadical = function (selected) {
	if (selected.$ === 'Just') {
		...
		return $author$project$Main$viewPopup(radical);
	} else {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Main$viewTitle(title),
							A2(
...
var $author$project$Main$viewAboutRoute = A2($author$project$Main$viewPage, 'ついて', 'こんにちは、サシンです。\n こんアプリの作ったものですよ。');
...
var $author$project$Main$viewHeaderButton = F3(
	function (label, action, buttonType) {
		var _v0 = function () {
			if (buttonType.$ === 'FilterButton') {
				return _Utils_Tuple2($author$project$Main$theme.buttonBgColor, $author$project$Main$theme.buttonBgHover);
			} else {
				return _Utils_Tuple2($author$project$Main$theme.buttonBgColorAlt, $author$project$Main$theme.buttonBgHoverAlt);
			}
		}();
		var bg = _v0.a;
		var bgHover = _v0.b;
...
var $author$project$Main$viewInactiveHeaderButton = function (label) {
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color($author$project$Main$theme.buttonBgColor),
				$mdgriffith$elm_ui$Element$Border$rounded(10),
				$mdgriffith$elm_ui$Element$padding(15),
				$mdgriffith$elm_ui$Element$Font$size(18),
				$mdgriffith$elm_ui$Element$Font$center,
...
var $author$project$Main$displayHeaderButton = F3(
		...
		switch (display.$) {
			case 'ListBySubject':
				if ((action.$ === 'DisplayBy') && (action.a.$ === 'ListBySubject')) {
					...
					return A3($author$project$Main$viewHeaderButton, label, action, $author$project$Main$FilterButton);
				}
			case 'ListByPart':
...
var $author$project$Pages$about = {content: 'This is the about page', route: $author$project$Routes$About, title: 'ついて'};
var $author$project$Pages$support = {content: '\n\n# Apple Pie Recipe\n\nFirst, invent the universe. Then bake an apple pie.\n\n', route: $author$project$Routes$Support, title: '❤'};
...
var $author$project$Main$viewHeaderLink = F2(
	function (label, url) {
		return A2(
			$mdgriffith$elm_ui$Element$link,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Background$color($author$project$Main$theme.buttonBgColorAlt),
					$mdgriffith$elm_ui$Element$Border$rounded(10),
					$mdgriffith$elm_ui$Element$padding(15),
					$mdgriffith$elm_ui$Element$Font$size(18),
					$mdgriffith$elm_ui$Element$Font$center,
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Background$color($author$project$Main$theme.buttonBgHoverAlt),
							$mdgriffith$elm_ui$Element$Font$color($author$project$Main$theme.fontColorLighter)
						]))
				]),
			{
...
var $author$project$Main$viewRadical = function (radical) {
	return A2(
		$mdgriffith$elm_ui$Element$Input$button,
		_List_fromArray(
			[
			...
			]),
		{
			...
			onPress: $elm$core$Maybe$Just(
				$author$project$Main$SelectRadical(radical))
		});
};
...
var $author$project$Main$viewSupportRoute = A2($author$project$Main$viewPage, 'ありがとうございます！！', 'お問い合わせはこちらからどうぞ！');
			...
			[
				...
				$mdgriffith$elm_ui$Element$layoutWith,
				{
					options: _List_fromArray(
						[
							...
							A3(
								$mdgriffith$elm_ui$Element$FocusStyle,
								$elm$core$Maybe$Just($author$project$Main$theme.contentBgColorLighter),
								$elm$core$Maybe$Just($author$project$Main$theme.contentBgColorLighter),
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$Font$color($author$project$Main$theme.fontColor),
						$mdgriffith$elm_ui$Element$Font$size($author$project$Main$theme.textSize),
					...
					_List_fromArray(
						[
							...
							switch (_v0.$) {
								...
								case 'About':
									return $author$project$Main$viewAboutRoute;
								default:
									return $author$project$Main$viewSupportRoute;
							}
						}()
						])))
			]),
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Radical.Radical":{"args":[],"type":"{ radical : Char.Char, name : String.String, meaning : Meaning.Meaning, alternates : List.List Char.Char, part : Part.Part, examples : List.List Char.Char, subject : Subject.Subject }"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"SelectRadical":["Radical.Radical"],"DeselectRadical":[],"UrlChanged":["Url.Url"],"LinkClicked":["Browser.UrlRequest"],"SetRoute":["Routes.Route"],"DisplayBy":["Main.Display"],"KeyDown":["String.String"]}},"Char.Char":{"args":[],"tags":{"Char":[]}},"Main.Display":{"args":[],"tags":{"ListBySubject":[],"ListByPart":[],"NoCategories":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Meaning.Meaning":{"args":[],"tags":{"Same":[],"Different":["String.String"]}},"Part.Part":{"args":[],"tags":{"Left":[],"Right":[],"Top":[],"Bottom":[],"Enclose":[],"Hang":[],"Wrap":[],"None":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Routes.Route":{"args":[],"tags":{"Home":[],"About":[],"Support":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Subject.Subject":{"args":[],"tags":{"Nature":[],"BodyParts":[],"People":[],"Enclosures":[],"VerbsAndLanguage":[],"NaturalMaterials":[],"MathAndMeasurement":[],"Food":[],"Animals":[],"Warfare":[],"ManMadeTools":[],"Senses":[],"Supernatural":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}}}}})}});}(this));