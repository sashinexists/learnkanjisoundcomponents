...
var $author$project$Shared$ListByKanaRow = {$: 'ListByKanaRow'};
...
var $author$project$SoundComponent$SoundComponent = F2(
	function (component, sound) {
		return {component: component, sound: sound};
	});
var $author$project$SoundComponents$soundComponents = _List_fromArray(
	[
		A2(
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		var model = {
			...
			display: $author$project$Shared$ListByKanaRow,
			key: key,
			route: $author$project$Main$getRouteFromPath(url.path),
			selected: _List_Nil,
			soundComponents: $author$project$SoundComponents$soundComponents,
			url: url
		};
...
var $author$project$Shared$KeyDown = function (a) {
	return {$: 'KeyDown', a: a};
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$decodeKey = A2($elm$json$Json$Decode$field, 'key', $elm$json$Json$Decode$string);
var $author$project$Main$keyDownListener = A2($elm$json$Json$Decode$map, $author$project$Shared$KeyDown, $author$project$Main$decodeKey);
...
var $author$project$Shared$NewSoundComponentsList = function (a) {
	return {$: 'NewSoundComponentsList', a: a};
};
...
var $author$project$Main$deselectSoundComponent = F2(
	function (model, soundComponent) {
		var selection = A2(
			$elm$core$List$filter,
			function (s) {
				return !_Utils_eq(soundComponent, s);
			},
			model.selected);
		return _Utils_Tuple2(
			_Utils_update(
		...
		switch (msg.$) {
			...
			case 'SelectSoundComponent':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'DeselectSoundComponent':
				var soundComponent = msg.a;
				return A2($author$project$Main$deselectSoundComponent, model, soundComponent);
			case 'KeyDown':
				var key = msg.a;
			...
			case 'Randomise':
				return _Utils_Tuple2(
					...
					A2(
						$elm$random$Random$generate,
						$author$project$Shared$NewSoundComponentsList,
						$elm_community$random_extra$Random$List$shuffle(model.soundComponents)));
			case 'NewSoundComponentsList':
				var soundComponents = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							device: $mdgriffith$elm_ui$Element$classifyDevice(
								{
									height: $elm$core$Basics$round(data.viewport.height),
...
var $author$project$Theme$colorPalette = {
	...
	forestGreenCrayola: A3($mdgriffith$elm_ui$Element$rgb255, 107, 179, 124),
	gainsboro: A3($mdgriffith$elm_ui$Element$rgb255, 227, 221, 224),
	independence: A3($mdgriffith$elm_ui$Element$rgb255, 56, 59, 83),
	independenceDark: A3($mdgriffith$elm_ui$Element$rgb255, 58, 61, 85),
	independenceLight: A3($mdgriffith$elm_ui$Element$rgb255, 74, 78, 109),
	ivory: A3($mdgriffith$elm_ui$Element$rgb255, 254, 252, 236),
	middleGreen: A3($mdgriffith$elm_ui$Element$rgb255, 69, 135, 84),
	oldMauve: A3($mdgriffith$elm_ui$Element$rgb255, 92, 30, 56),
	raisinBlack: A3($mdgriffith$elm_ui$Element$rgb255, 25, 25, 36),
...
var $author$project$Theme$theme = {bgColor: $author$project$Theme$colorPalette.raisinBlack, buttonBgColor: $author$project$Theme$colorPalette.middleGreen, buttonBgColorAlt: $author$project$Theme$colorPalette.spaceCadet, buttonBgHover: $author$project$Theme$colorPalette.forestGreenCrayola, buttonBgHoverAlt: $author$project$Theme$colorPalette.englishViolet, contentBgColor: $author$project$Theme$colorPalette.independence, contentBgColorDarker: $author$project$Theme$colorPalette.independenceDark, contentBgColorLighter: $author$project$Theme$colorPalette.independenceLight, fontColor: $author$project$Theme$colorPalette.ivory, fontColorLighter: $author$project$Theme$colorPalette.culturedWhite, textSize: 16};
	...
	function (label, action, buttonType) {
		var _v0 = function () {
			if (buttonType.$ === 'FilterButton') {
				return _Utils_Tuple2($author$project$Theme$theme.buttonBgColor, $author$project$Theme$theme.buttonBgHover);
			} else {
				return _Utils_Tuple2($author$project$Theme$theme.buttonBgColorAlt, $author$project$Theme$theme.buttonBgHoverAlt);
			}
		}();
		var bg = _v0.a;
		var bgHover = _v0.b;
...
var $author$project$Desktop$viewInactiveHeaderButton = function (label) {
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color($author$project$Theme$theme.buttonBgColor),
				$mdgriffith$elm_ui$Element$Border$rounded(10),
				$mdgriffith$elm_ui$Element$padding(15),
				$mdgriffith$elm_ui$Element$Font$size(18),
				$mdgriffith$elm_ui$Element$Font$center,
...
var $author$project$Desktop$displayHeaderButton = F3(
	function (label, action, display) {
		if (display.$ === 'NoCategories') {
			if ((action.$ === 'DisplayBy') && (action.a.$ === 'NoCategories')) {
				var _v2 = action.a;
				return $author$project$Desktop$viewInactiveHeaderButton(label);
			} else {
				return A3($author$project$Desktop$viewHeaderButton, label, action, $author$project$Desktop$FilterButton);
			}
		} else {
			if ((action.$ === 'DisplayBy') && (action.a.$ === 'ListByKanaRow')) {
				var _v4 = action.a;
				return $author$project$Desktop$viewInactiveHeaderButton(label);
			} else {
				return A3($author$project$Desktop$viewHeaderButton, label, action, $author$project$Desktop$FilterButton);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				'音',
				$author$project$Shared$DisplayBy($author$project$Shared$ListByKanaRow),
				display),
				A3(
				$author$project$Desktop$displayHeaderButton,
				'なし',
...
var $author$project$Desktop$viewSiteTitle = $mdgriffith$elm_ui$Element$text('漢字の音学ぶ教室へようこそ！！');
...
var $author$project$Shared$DeselectSoundComponent = function (a) {
	return {$: 'DeselectSoundComponent', a: a};
};
...
var $author$project$Desktop$viewSelectedSoundComponent = function (soundComponent) {
	return A2(
		$mdgriffith$elm_ui$Element$Input$button,
		_List_fromArray(
			[
			...
			label: A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$text(soundComponent.sound)),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
						...
						$mdgriffith$elm_ui$Element$text(
							$elm$core$String$fromChar(soundComponent.component)))
					])),
			onPress: $elm$core$Maybe$Just(
				$author$project$Shared$DeselectSoundComponent(soundComponent))
		});
};
var $author$project$Shared$SelectSoundComponent = function (a) {
	return {$: 'SelectSoundComponent', a: a};
};
var $author$project$Desktop$viewUnselectedSoundComponent = function (soundComponent) {
	return A2(
		$mdgriffith$elm_ui$Element$Input$button,
		_List_fromArray(
			[
			...
			]),
		{
			...
			onPress: $elm$core$Maybe$Just(
				$author$project$Shared$SelectSoundComponent(soundComponent))
		});
};
var $author$project$Desktop$viewSoundComponent = F2(
	function (selected, soundComponent) {
		return A2(
			$elm$core$List$any,
			function (selectedComponent) {
				return _Utils_eq(selectedComponent, soundComponent);
			},
			selected) ? $author$project$Desktop$viewSelectedSoundComponent(soundComponent) : $author$project$Desktop$viewUnselectedSoundComponent(soundComponent);
	});
...
var $author$project$Desktop$viewSoundComponents = F2(
	function (selected, soundComponents) {
		return A2(
			...
			A2(
				$elm$core$List$map,
				$author$project$Desktop$viewSoundComponent(selected),
				soundComponents));
	});
var $author$project$Kana$AIUEO = {$: 'AIUEO'};
var $author$project$Kana$HAHIFUHEHO = {$: 'HAHIFUHEHO'};
var $author$project$Kana$KAKIKUKEKO = {$: 'KAKIKUKEKO'};
var $author$project$Kana$MAMIMUMEMO = {$: 'MAMIMUMEMO'};
var $author$project$Kana$N = {$: 'N'};
var $author$project$Kana$NANINUNENO = {$: 'NANINUNENO'};
var $author$project$Kana$RARIRURERO = {$: 'RARIRURERO'};
var $author$project$Kana$SASHISUSESO = {$: 'SASHISUSESO'};
var $author$project$Kana$TACHITSUTETO = {$: 'TACHITSUTETO'};
var $author$project$Kana$WAWO = {$: 'WAWO'};
var $author$project$Kana$YAYUYO = {$: 'YAYUYO'};
var $author$project$Desktop$allKanaRows = _List_fromArray(
	[$author$project$Kana$AIUEO, $author$project$Kana$KAKIKUKEKO, $author$project$Kana$SASHISUSESO, $author$project$Kana$TACHITSUTETO, $author$project$Kana$NANINUNENO, $author$project$Kana$HAHIFUHEHO, $author$project$Kana$MAMIMUMEMO, $author$project$Kana$YAYUYO, $author$project$Kana$RARIRURERO, $author$project$Kana$WAWO, $author$project$Kana$N]);
var $author$project$Kana$printKanaRowInKana = function (kanaRow) {
	switch (kanaRow.$) {
		case 'AIUEO':
			return 'アイウエオ';
		case 'KAKIKUKEKO':
...
var $author$project$Desktop$isSoundFromKanaRow = F2(
	function (kanaRow, soundComponent) {
		var startsWith = A2(
		...
		return A2(
			$elm$core$List$any,
			function (letter) {
				return A2($elm$core$String$startsWith, letter, soundComponent.sound);
			},
			startsWith);
	});
...
var $author$project$Desktop$viewKanaRow = F3(
	function (kanaRow, selected, soundComponents) {
		return A2(
			$elm$core$List$any,
			$author$project$Desktop$isSoundFromKanaRow(kanaRow),
			soundComponents) ? A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
					...
					A2(
						...
						A2(
							...
							function (soundComponent) {
								return A2($author$project$Desktop$isSoundFromKanaRow, kanaRow, soundComponent);
							},
							soundComponents)))
				])) : $mdgriffith$elm_ui$Element$text('');
	});
var $author$project$Desktop$viewSoundComponentsByKana = F2(
	function (selected, soundComponents) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
			...
			A2(
				$elm$core$List$map,
				function (kanaRow) {
					return A3($author$project$Desktop$viewKanaRow, kanaRow, selected, soundComponents);
				},
				$author$project$Desktop$allKanaRows));
	});
var $author$project$Desktop$view = function (model) {
	return {
				...
				$mdgriffith$elm_ui$Element$layoutWith,
				{
					options: _List_fromArray(
						[
							...
							A3(
								$mdgriffith$elm_ui$Element$FocusStyle,
								$elm$core$Maybe$Just($author$project$Theme$theme.contentBgColorLighter),
								$elm$core$Maybe$Just($author$project$Theme$theme.contentBgColorLighter),
								$elm$core$Maybe$Just($author$project$Theme$focusBoxShadow)))
						])
				},
				_List_fromArray(
					[
				...
				A2(
					...
					_List_fromArray(
						[
							...
							if (_v0.$ === 'NoCategories') {
								return A2($author$project$Desktop$viewSoundComponents, model.selected, model.soundComponents);
							} else {
								return A2($author$project$Desktop$viewSoundComponentsByKana, model.selected, model.soundComponents);
							}
						}()
						])))
			]),
...
var $author$project$Phone$viewInactiveHeaderButton = function (label) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var $author$project$Phone$displayHeaderButton = F3(
	function (label, action, display) {
		if (display.$ === 'NoCategories') {
			if ((action.$ === 'DisplayBy') && (action.a.$ === 'NoCategories')) {
				var _v2 = action.a;
				return $author$project$Phone$viewInactiveHeaderButton(label);
			} else {
				return A3($author$project$Phone$viewHeaderButton, label, action, $author$project$Phone$FilterButton);
			}
		} else {
			if ((action.$ === 'DisplayBy') && (action.a.$ === 'ListByKanaRow')) {
				var _v4 = action.a;
...
var $author$project$Phone$viewFilterButtons = function (display) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
...
var $author$project$Phone$viewSelectedSoundComponent = function (soundComponent) {
	return A2(
		$mdgriffith$elm_ui$Element$Input$button,
		_List_fromArray(
			[
...
var $author$project$Phone$viewUnselectedSoundComponent = function (soundComponent) {
	return A2(
		$mdgriffith$elm_ui$Element$Input$button,
		_List_fromArray(
			[
...
var $author$project$Phone$viewSoundComponent = F2(
	function (selected, soundComponent) {
		return A2(
			$elm$core$List$any,
			function (selectedComponent) {
			...
			selected) ? $author$project$Phone$viewSelectedSoundComponent(soundComponent) : $author$project$Phone$viewUnselectedSoundComponent(soundComponent);
	});
var $author$project$Phone$viewSoundComponents = F2(
	function (selected, soundComponents) {
		return A2(
			...
			A2(
				$elm$core$List$map,
				$author$project$Phone$viewSoundComponent(selected),
				soundComponents));
	});
var $author$project$Phone$allKanaRows = _List_fromArray(
	[$author$project$Kana$AIUEO, $author$project$Kana$KAKIKUKEKO, $author$project$Kana$SASHISUSESO, $author$project$Kana$TACHITSUTETO, $author$project$Kana$NANINUNENO, $author$project$Kana$HAHIFUHEHO, $author$project$Kana$MAMIMUMEMO, $author$project$Kana$YAYUYO, $author$project$Kana$RARIRURERO, $author$project$Kana$WAWO, $author$project$Kana$N]);
var $author$project$Phone$isSoundFromKanaRow = F2(
	function (kanaRow, soundComponent) {
		var startsWith = A2(
			$elm$core$String$split,
			'',
...
var $author$project$Phone$viewKanaRow = F3(
	function (kanaRow, selected, soundComponents) {
		return A2(
			$elm$core$List$any,
			$author$project$Phone$isSoundFromKanaRow(kanaRow),
			soundComponents) ? A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
				...
				[
					...
					A2(
						...
						A2(
							$elm$core$List$filter,
							function (soundComponent) {
								return A2($author$project$Phone$isSoundFromKanaRow, kanaRow, soundComponent);
							},
							soundComponents)))
				])) : $mdgriffith$elm_ui$Element$text('');
	});
var $author$project$Phone$viewSoundComponentsByKana = F2(
	function (selected, soundComponents) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
			...
			A2(
				$elm$core$List$map,
				function (kanaRow) {
					return A3($author$project$Phone$viewKanaRow, kanaRow, selected, soundComponents);
				},
				$author$project$Phone$allKanaRows));
	});
var $author$project$Phone$view = function (model) {
	return {
		body: _List_fromArray(
			[
				A3(
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$Phone$viewHeader(model.display),
							function () {
							var _v0 = model.display;
							if (_v0.$ === 'NoCategories') {
								return A2($author$project$Phone$viewSoundComponents, model.selected, model.soundComponents);
							} else {
								return A2($author$project$Phone$viewSoundComponentsByKana, model.selected, model.soundComponents);
							}
						}()
						])))
			]),
...
var $author$project$Main$view = function (model) {
	...
	switch (_v0.$) {
		case 'Desktop':
			return $author$project$Desktop$view(model);
		case 'Phone':
			return $author$project$Phone$view(model);
		case 'Tablet':
			return $author$project$Desktop$view(model);
		default:
			return $author$project$Desktop$view(model);
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{init: $author$project$Main$init, onUrlChange: $author$project$Shared$UrlChanged, onUrlRequest: $author$project$Shared$LinkClicked, subscriptions: $author$project$Main$subscriptions, update: $author$project$Main$update, view: $author$project$Main$view});
